...
<style>
  ...
  .table-header { background-color: #fee2e2; font-weight: 600; }
...
<main class="pt-20 lg:pt-24 p-6 lg:ml-64 min-h-screen">
  ...
  <div id="activeTableContainer" class="overflow-x-auto bg-white shadow-lg rounded-2xl border border-red-100">
    <table class="min-w-full divide-y divide-gray-200">
      <thead class="table-header">
        <tr>
          <th>#</th><th>Type</th><th>Description</th><th>Status</th><th>Location</th><th>Actions</th>
        </tr>
      </thead>
  ...
  <div id="historyTableContainer" class="overflow-x-auto bg-white shadow-lg rounded-2xl border border-red-100 hidden">
    <table class="min-w-full divide-y divide-gray-200">
      <thead class="table-header">
        <tr>
          <th>#</th><th>Type</th><th>Description</th><th>Status</th><th>Location</th><th>Resolved At</th>
        </tr>
      </thead>
...
window.addEventListener("toggle-sidebar",()=>{sidebar.classList.toggle("open");overlay.classList.toggle("hidden");overlay.classList.toggle("active");});
